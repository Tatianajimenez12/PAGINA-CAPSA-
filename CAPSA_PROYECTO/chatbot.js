...
function showPopup(question, index) {
    const responses = {
        ...
        2: "Puedes agendar un cuidado o servicio directamente a través del ícono de WhatsApp que aparece al inicio de la página. Haz clic en el ícono para enviar un mensaje automático o escanea el código QR que se muestra en esa sección para contactarnos de manera rápida y sencilla.",
        ...
        6: "Puedes comunicarte con nosotros a través del número de WhatsApp que aparece en la página principal de CAPSA. También puedes utilizar el ícono de WhatsApp para iniciar una conversación rápida.",
